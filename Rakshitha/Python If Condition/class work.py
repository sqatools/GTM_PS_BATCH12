# write a python program to print square of the number if is divisible by 3 or 7 else print cube
num1=15
...
#total bill as per 25/unit rate: 2525
# enter the number of units consumed:99
# total bill as per 15/unit rate: 1485
# enter the number of units consumed:300
# total bill as per 30/unit rate: 9000
